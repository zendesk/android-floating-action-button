...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mTyepface = attr.getString(R.styleable.FloatingActionsMenu_fab_typeface);
        attr.recycle();
    ...
    private void createLabels() {
        ...
        for (int i = 0; i < mButtonsCount; i++) {
            ...
            if (mTyepface != null) {
                Typeface typeface = Typeface.createFromAsset(context.getAssets(), mTyepface);
