...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mButtonSpacing = (int) (getResources().getDimension(R.dimen.fab_actions_spacing) - getResources()
                .getDimension(R.dimen.fab_shadow_radius) - getResources().getDimension(R.dimen.fab_shadow_offset));
        ...
        mChangeAction = attr.getBoolean(R.styleable.FloatingActionsMenu_fab_changeAction, false);
        attr.recycle();
    ...
    private void createAddButton(Context context) {
        mAddButton = new AddFloatingActionButton(context) {
            ...
            public void setAlternativeActionStyle(FloatingActionButton button) {
        ...
        case EXPAND_DOWN:
            ...
            for (int i = mButtonsCount - 1; i >= 0; i--) {
                ...
                if (label != null) {
                    ...
                    int labelTop = childY - mLabelsVerticalOffset + (child.getMeasuredHeight() - label
                            .getMeasuredHeight()) / 2;
    ...
    private void changeActionMode() {
        if (mChangeAction) {
            mAddButton.setBackgroundResource(android.R.drawable.btn_star);
            mAddButton.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
