...
import com.getbase.floatingactionbutton.listener.ScrollDirectionDetector;
import com.getbase.floatingactionbutton.listener.ScrollDirectionListener;
...
public class FloatingActionsMenu extends ViewGroup implements ToggleInterface{
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        toggleImpl = new ToggleImpl(this);
    }
    ...
    public void toggle(boolean visible, boolean animate, boolean force) {
        toggleImpl.toggle(visible, animate, force);
    }
    ...
    public int getMarginBottom() {
        return toggleImpl.getMarginBottom();
    }

    public void attachToListView(ListView listView) {
        FamOnScrollListener famOnScrollListener = new FamOnScrollListener();
        famOnScrollListener.setFloatingActionButton(this);
        famOnScrollListener.setListView(listView);
        listView.setOnScrollListener(famOnScrollListener);
    }

    public class FamOnScrollListener extends ScrollDirectionDetector implements ScrollDirectionListener {
        private FloatingActionsMenu floatingActionsMenu;

        public FamOnScrollListener() {
            setScrollDirectionListener(this);
        }

        private void setFloatingActionButton(@NonNull FloatingActionsMenu floatingActionsMenu) {
