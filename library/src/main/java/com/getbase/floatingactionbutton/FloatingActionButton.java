...
public class FloatingActionButton extends ImageButton implements ToggleInterface{
    ...
    public void attachToListView(ListView listView) {
        FabOnScrollListener fabOnScrollListener = new FabOnScrollListener();
        fabOnScrollListener.setFloatingActionButton(this);
        fabOnScrollListener.setListView(listView);
        listView.setOnScrollListener(fabOnScrollListener);
    }
